...
description: "After passing a PolyFundr challenge, a same-size funded account opens automatically with a 90% profit split, fresh balance, and the same risk rules."
---
