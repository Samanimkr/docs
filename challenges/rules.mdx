...
| Consistency                   | No single day over 30% of total profit               | Also applies to your first payout only       |
...
The consistency rule also applies to your **first funded payout** (no single
trading day over 30% of total realized profit). Subsequent payouts are not
