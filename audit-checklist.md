...
- [x] Make `/getting-started/how-it-works` the canonical overview page and reduce duplicate overview copy elsewhere.
- [x] Make `/challenges/rules` the canonical rules page and trim `/faq/rules` down to short clarifications.
- [x] Make `/funded/payouts` the canonical payout page and trim duplicated payout explanations elsewhere.
- [x] Rewrite `/faq/rules`.
- [x] Rewrite `/funded/payouts`.
- [x] Rewrite `/getting-started/introduction`.
- [x] Rewrite `/challenges/overview`.
- [x] Rewrite `/faq/payouts`.
- [x] Remove or verify unsupported availability claims such as broad country-support language.

## P2 layout and UX

- [x] Add a clearer “Start here” path on the homepage for first-time readers.
- [x] Replace oversized homepage suggested-article placeholders with real screenshots, diagrams, or smaller useful thumbnails.
- [x] Add quick-reference rule summaries near the top of `/challenges/rules` and `/funded/risk-rules`.
- [ ] Add a stronger `Demo vs Challenge vs Funded` comparison.
- [x] Add a stronger `Challenge vs Funded` comparison.
- [ ] Tighten mobile article header and breadcrumb treatment on long-title pages.
- [x] Keep FAQ answers shorter and link back to deeper source pages.

## P3 diagrams and images

- [x] Create a simple `Buy challenge -> Pass rules -> Get funded -> Request payout` flow graphic.
- [x] Create a daily drawdown reset diagram.
- [x] Create a trailing high-water-mark drawdown diagram.
...
- [x] Create a payout lifecycle diagram.
